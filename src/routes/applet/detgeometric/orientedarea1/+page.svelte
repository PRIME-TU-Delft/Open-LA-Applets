...
<Canvas2D zoom3d={50}>
  ...
  <!-- e1 -->
  <Vector2D direction={new Vector2(1, 0)} length={1} color={PrimeColor.ultramarine} let:endPoint>
    <Latex2D latex={'\\mathbf{e_1}'} offset={new Vector2(-0.5, -0.15)} position={endPoint} />
  </Vector2D>

  <!-- e2 -->
  <Vector2D direction={new Vector2(0, 1)} length={1} color={PrimeColor.ultramarine} let:endPoint>
    <Latex2D latex={'\\mathbf{e_2}'} offset={new Vector2(-0.4, -0.3)} position={endPoint} />
  </Vector2D>

  <Latex2D latex={'C = \\mathbf{u} + \\mathbf{v}'} offset={new Vector2(0.1, 0.2)} position={C} />
