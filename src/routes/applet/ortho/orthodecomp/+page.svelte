<script lang="ts">
  ...
  import { Axis3D, Canvas3D, Latex3D, Vector3D, PlaneFromNormal, Point3D } from '$lib/threlte-components';
...
<Canvas3D
cameraPosition={new Vector3(10, 10, 17)}
zoom={50}
title="Name to be inserted"
>
  <!-- v -->
  ...
  <Latex3D latex={'Proj_V(\\mathbf{v})'} position={proj_v.clone().add(new Vector3(0.2, 0, 0.2))} color={PrimeColor.red} />
