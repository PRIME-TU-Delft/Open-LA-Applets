<script lang="ts">
  ...
  // APPLET OBJECTS
  // ##############
  const Vertex1 = new Vector2(0, 0);
  const Vertex2 = new Vector2(4, 0);
  const FocalPoint1 = new Vector2(-1, 0);
  const FocalPoint2 = new Vector2(5, 0);
