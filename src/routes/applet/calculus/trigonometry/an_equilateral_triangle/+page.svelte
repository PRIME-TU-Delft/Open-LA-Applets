<script lang="ts">
  ...
  const appletObjects: AppletObject[] = [
    new Polygon(
      [new Vector2(2, 0), new Vector2(2.3, 0), new Vector2(2.3, 0.3), new Vector2(2, 0.3)],
      PrimeColor.black,
      { width: 1.2 }
    ),
    new Polygon(
      [new Vector2(2, 0), new Vector2(4, 0), new Vector2(2, 2 * Math.sqrt(3))],
      PrimeColor.blue,
      {
        width: 1.3
      }
    ...
    new Polygon(
      [new Vector2(0, 0), new Vector2(2, 0), new Vector2(2, 2 * Math.sqrt(3))],
      PrimeColor.blue,
      {
        width: 1.3
      }
