<script lang="ts">
  ...
  import { AppletObject, Polygon, Text } from '$lib/template/TemplateAppletObjects';
  ...
  const appletObjects: AppletObject[] = [
    new Polygon(
      ...
      { fillStyle: 'full', legendText: "\\text{Positive derivative~}f'" }
    ),
    new Polygon(
      [
        new Vector2(Math.PI / 3, RegionHeight),
      ...
      { fillStyle: 'full', legendText: "\\text{Negative derivative~}f'" }
    ),
    new Polygon(
      [
        new Vector2((2 * Math.PI) / 3, RegionHeight),
    ...
    new Polygon(
      ...
      { fillStyle: 'full', legendText: '\\text{Strictly increasing~}f', legendShape: 'diamond' }
    ),
    new Polygon(
      [
        new Vector2(Math.PI / 3, -RegionHeight),
      ...
      { fillStyle: 'full', legendText: '\\text{Strictly decreasing~}f', legendShape: 'diamond' }
    ),
    new Polygon(
      [
        new Vector2((2 * Math.PI) / 3, -RegionHeight),
