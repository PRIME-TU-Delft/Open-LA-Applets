<script lang="ts">
  ...
  const appletObjects: AppletObject[] = [
    ...
    new Point(new Vector2(0, 0), PrimeColor.raspberry, {
      legendText: '\\text{Local extremum}'
    })
  ];
</script>
...
>
  ...
  <Axis skipX={0} skipY={0} showAxisNumbersX={true} showAxisNumbersY={true} />
</Canvas2D>
