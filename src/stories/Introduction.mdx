...
The applets are created using [Svelte](https://svelte.dev/), [Threlte](https://threlte.xyz/) for 3D graphics and [D3.js](https://d3js.org/) for 2D graphics.
...
- [2D applets](./?path=/docs/tutorials-tutorial-2d--docs)
- [3D applets](./?path=/docs/tutorials-tutorial-3d--docs)
- [Translating applets](./?path=/docs/tutorials-tutorial-translation--docs)

## Uploading applets

Once you are happy with your applet, you can make a pull request to the main branch. The applet will be automatically
deployed to `https://deploy-preview-[PR_NUMBER]--openla-preview.netlify.app/`. Here you can test the applet in a production
