...
<!-- 
This story showcases alternative legend positioning. Legend position options are `top-left`, `top-center`, `top-right`, `center-left`, `center`, `center-right`, `bottom-left`, and `bottom-right`. 
```typescript
const legendFormulaPosition="bottom-left"
```
 -->
  ...
  {#snippet template(_args)}
    <div class="h-[300px] overflow-hidden rounded-lg">
      <Canvas2D
        ...
        legendFormulaPosition="bottom-left"
      >
        <Vector2D
          origin={new Vector2(0, 0)}
          direction={new Vector2(1, 1)}
