<script context="module">
  ...
  const { Story } = defineMeta({
    ...
    argTypes: {
      origin: {
        description: 'The origin of the line. Required.',
        control: {
          type: 'object'
        }
      },
      direction: {
        description: 'The direction of the line. Required.',
        control: {
          type: 'object'
        }
      },
...
<Story name="With origin defined" source args={{ origin: new Vector2(0, 1) }} />
