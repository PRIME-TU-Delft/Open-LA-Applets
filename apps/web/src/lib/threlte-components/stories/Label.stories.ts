...
const meta = {
    ...
    argTypes: {
        ...
        color: {
            control: { type: 'select' },
            description: "The color of the label. We recommend using a [PrimeColor](/?path=/docs/colors--docs)",
        ...
        title: {
            description: "The text of the label. Alternatively you can use the default slot to populate this field."
        }
    },
    args: {
