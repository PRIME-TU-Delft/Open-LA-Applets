...
const meta = {
    ...
    argTypes: {
        vs: {
            control: { type: 'select' },
            description: "The two vectors that make up the angle. The angle is the angle between the two vectors.",
        ...
        size: {
            description: "The size of the angle. This is the length/radius of the lines that make up the angle."
        },
        origin: {
        ...
        color: {
            control: { type: 'select' },
            description: "The color of the angle. We recommend using a [PrimeColor](/?path=/docs/colors--docs)",
